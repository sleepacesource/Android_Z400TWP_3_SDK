...
import com.sleepace.z400twp_3sdk.demo.fragment.DeviceFragment;
import com.sleepace.z400twp_3sdk.demo.fragment.LoginFragment;
import com.sleepace.z400twp_3sdk.demo.fragment.ReportFragment;
...
//	public static final String deviceId = "y24mlthq3fxga"; //7klkgdpedxyfx
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		z400twpHelper = Z400TWPHelper.getInstance(this);
		findView();
		initListener();
		initUI();
		checkPermissions();
